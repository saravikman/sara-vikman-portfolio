...
return (
  <ProjectLayout>
      ...
      <div className="flex flex-wrap px-36 -mt-36">
        <img className="rounded-md w-full my-[--image-margin]" src={content.featuredImage}></img>
        <div className="grid grid-cols-2 gap-[--image-gap] my-[--image-margin] items-center">
          <img className="rounded-md object-contain" src="https://www.datocms-assets.com/99032/1682803734-12.jpg"></img>
          <img className="rounded-md object-contain" src="https://www.datocms-assets.com/99032/1682803734-12.jpg"></img>
        </div>
