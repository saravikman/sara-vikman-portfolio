  ...
  <header className={`py-6 px-6 md:px-10 m-auto flex justify-between items-center fixed z-50 w-full text-${theme}-100 backdrop-blur-lg`}>
    ...
    <div className="flex justify-between">
      ...
      className="hamburger w-9 relative -mt-[0.1rem] ml-6">
        <span className={`hamburger-line top bg-${theme} block h-[0.15rem] w-full rounded-full absolute top-0 transition-all duration-500 ease-linear`}></span>
