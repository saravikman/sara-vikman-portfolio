...
const Header = ({ siteTitle, theme }) => {
  ...
  return (
    <>
      <header className={`py-6 px-6 md:px-10 m-auto flex justify-between items-center fixed z-50 w-full text-${theme}-100 backdrop-blur-lg bg-zinc-50/10 border-b border-zinc-100/50`}>
        <Link to="/">
